...
global.header = `© baymax-bot v${require('package.json').version} (Beta)`
global.footer = `Made On Earth By Mr Juice`
global.status = Object.freeze({
   ...
   owner: Func.Styles('This command only for owner Mr Juice.'),
