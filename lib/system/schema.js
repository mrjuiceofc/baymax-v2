module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('msg' in setting)) setting.msg = 'Hi +tag 🪸\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Instagram* : https://instagram.com/mr_juice7\n◦ *Source* : https://github.com/mrjuice01/error\n\nIf you find an error or want to upgrade premium plan contact the owner.'
      if (!isNumber(setting.style)) setting.style = 2
      if (!('cover' in setting)) setting.cover = 'https://graph.org/file/5adaa76ffad91e85bc661.jpg'
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/GRuUvhCqhHK08msKMadAji'
   } else {
      global.db.setting = {
         autodownload: true,
         debug: false,
         ...
         msg: 'Hi +tag 🪸\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Instagram* : https://instagram.com/mr_juice7\n◦ *Source* : https://github.com/mrjuice01/error\n\nIf you find an error or want to upgrade premium plan contact the owner.',
         style: 2,
         cover: 'https://graph.org/file/5adaa76ffad91e85bc661.jpg',
         link: 'https://chat.whatsapp.com/GRuUvhCqhHK08msKMadAji'
      }
   }
}